...
function ApplicationHome() {
  ...
  useEffect(() => {
    ...
    if (location.id) {
      let elem = document.getElementById(`${location.id}`);
      elem.scrollIntoView({
        behavior: "smooth",
        block: "end",
        inline: "nearest",
  ...
  return (
    <>
      <HomeNavBar goToSection={scrollToView} />
        ...
        <div id="content" className="site-content center-relative">
          ...
          <div id="pricing" className="section">
            ...
            <div className="section-wrapper block content-1170 center-relative">
              ...
              <div className="one_third onethird-last" id="pricing_two">
              ...
              <div className="one_third onethird-last">
                <div className="pricing-table ">
